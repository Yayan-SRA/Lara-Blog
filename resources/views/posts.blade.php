    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <h3 class="card-title"><a href="/posts/{{ $posts[0]->slug }}" style="text-decoration: none; color:black">
                        {{ $posts[0]->title }}
                    </a>
                </h3>
                <p>
        ...
        <div class="row">
            @foreach ($posts->skip(1) as $post)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="px-3 py-2 position-absolute" style="background-color: rgba(0, 0, 0, 0.7)">
